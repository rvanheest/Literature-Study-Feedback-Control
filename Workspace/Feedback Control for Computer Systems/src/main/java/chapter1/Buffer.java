...
public class Buffer {
	...
	/**
	 * Performs <code>u</code> work upstream puts it in the ready pool. A random percentage is
	 * taken out from the ready pool and put into the queue. Another random percentage is taken
	 * from the queue and goes downstream.  
